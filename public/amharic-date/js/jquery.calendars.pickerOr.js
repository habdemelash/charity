...
(function($) { // Hide scope, no $ conflict
    ...
    var pluginName = 'calendarsPickerOr';
  ...
  maxDate: $.calendars.newDate(2010, 12, 31)}) */
        ...
        regionalOptions: { // Available regional settings, indexed by language/country code
            '': { // Default regional settings - English/US
                ...
                prevText: '&lt;Dura',
                prevStatus: "Ji'a darbe agarsiisi",
                prevJumpText: '&lt;&lt;',
                prevJumpStatus: 'Show the previous year',
                nextText: 'Ittaanaa&gt;',
                nextStatus: 'Show the next month',
                nextJumpText: '&gt;&gt;',
                nextJumpStatus: 'Waggaa itti aanu agarsiisi',
                currentText: 'Yeroo ammaa',
                currentStatus: 'Show the current month',
                todayText: "Har'a",
                todayStatus: 'Show today\'s month',
                clearText: 'Ifaa',
                clearStatus: 'Guyyoota hunda qulqulleessi',
                closeText: 'Cufuu',
                closeStatus: 'Close the datepicker',
                yearStatus: 'Waggaa jijjiiri',
                earlierText: '&#160;&#160;▲',
                laterText: '&#160;&#160;▼',
                monthStatus: "Ji'a jijjiiri",
                weekText: 'Wk',
                weekStatus: 'Week of the year',
                dayStatus: 'Select DD, M d, yyyy',
                defaultStatus: 'Guyyaa tokko filadhu',
                isRTL: false
            }
        },
...
$(selector).datepick('setDate', [date1, date2, date3]) */
  ...
  $('div.datepick-popup a:contains(10)')[0]) */
    ...
    var plugin = $.calendarsPickerOr; // Singleton instance
