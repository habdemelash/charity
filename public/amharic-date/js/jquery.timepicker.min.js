        ...
        (e.TimePicker = function () {
            ...
            (e.TimePicker.prototype = {
                ...
                _items: function (t, i) {
                    ...
                    for (
                        ...
                        o._isValidTime(t, r) && ((c = e("<li>").addClass("ui-menu-item").appendTo(s)), e("<a>").addClass("ui-corner-all").text(e.fn.timepicker.formatTime(t.options.timeFormat, r)).appendTo(c), c.data("time-value", r)),
            ...
            (e.fn.timepicker.formatTime = function (e, i) {
                var n = i.getHours(),
                    ...
                    a = i.getMinutes(),
                    o = i.getSeconds(),
                    s = { hh: t((0 === r ? 12 : r).toString(), "0", 2), HH: t(n.toString(), "0", 2), mm: t(a.toString(), "0", 2), ss: t(o.toString(), "0", 2), h: 0 === r ? 12 : r, H: n, m: a, s: o, p: n > 11 ? "ማታ" : "ቀን" },
                    c = e,
                    u = "";
                for (u in s) s.hasOwnProperty(u) && (c = c.replace(new RegExp(u, "g"), s[u]));
                return (c = c.replace(new RegExp("a", "g"), n > 11 ? "ማታ" : "ቀን"));
            }),
            (e.fn.timepicker.parseTime = (function () {
                ...
                return function (r) {
                    ...
                    (r = r.toLowerCase()), (o = /ቀ/.test(r)), (s = o ? !1 : /ማ/.test(r)), (r = r.replace(/[^0-9:]/g, "").replace(/:+/g, ":"));
                    for (var m = 0; i > m; m += 1)
                        if (t[m][0].test(r)) {
                    ...
                    return (
                        ...
                        c === !1 || u === !1 || l === !1
                            ...
                            : ((c = parseInt(c, 10)),
                              ...
                              c > 24 ? (r.length >= 6 ? e.fn.timepicker.parseTime(r.substr(0, 5)) : e.fn.timepicker.parseTime(r + "0" + (o ? "a" : "") + (s ? "p" : ""))) : (a.setHours(c, u, l), a))
                    );
                };
            })());
    })();
